...
import kronos from "../../public/kronos.jpg";
...
export default function Project() {
  return (
    <>
      ...
      <section
        className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:p-6"
        data-aos="fade-in"
        data-aos-duration="800"
      >
        <ProjectCard
          title="KRONOS"
          description="Built a 1U Self hosted Proxmox infrastructure server powering production apps, documentation, and developer tooling. Implemented Traefik reverse proxy, containerized services, automated deployments, and hardened security after mitigating large scale brute force attacks."
          linkHref="https://docs.ugaktp.com/docs/kronos/overview"
          imageUrl={kronos}
          year={"2026"}
        />
        <ProjectCard
