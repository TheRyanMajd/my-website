    ...
    <div key="1" className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1">
        <section className="align-center w-full py-4 md:py-8 lg:py-16 dotted">
          <div className="mx-auto container space-y-12 px-4 md:px-6 xl:space-y-16">
            <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:grid-cols-2 md:gap-16">
              <div
                className="px-auto text-center md:text-left col-span-1"
                data-aos="fade-up"
              ...
              >
                <h1 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem]">
                  ...
                  <TypeAnimation
                    ...
                    sequence={[
                      ...
                      "a Software Engineer",
                      1400,
                      "a GitHub Campus Expert",
                      1400,
                      "Prev Tech Director at UGAHacks",
                      1400,
                      "a 2x Founder",
                      1400,
                      "a CS Graduate from UGA",
                      1400,
                      "Ryan Majd",
                      1400,
                    ]}
                ...
                <p className="mx-auto my-4 max-w-[700px] text-gray-400 md:text-xl mb-4">
                  ...
                  products, cloud-based systems, and technical communities that
                  create real impact. I&apos;ve worked as a Software Engineering
                  Intern at&nbsp;
                  <Link
              ...
              <div
                className="mx-auto text-center md:text-right col-span-1"
                data-aos="fade-right"
                data-aos-duration="400"
              >
                <h1 className="lg:leading-tighter text-2xl font-semibold tracking-tighter sm:text-3xl md:text-4xl xl:text-[2.2rem] 2xl:text-[2.75rem] mb-2">
                  Building software, systems, and communities that scale
                </h1>
                <Image
                  alt="Ryan Majd"
        ...
        <section id="skills" className="w-full py-2 md:py-4 lg:py-8 dotted">
          <div className="mx-auto container grid items-center justify-center gap-4 px-4 text-center md:px-6 py-8">
            <div className="space-y-3">
              <h2
                className="text-3xl space-y-4 font-bold tracking-tighter sm:text-4xl md:text-5xl"
                data-aos="flip-up"
                data-aos-duration="400"
              >
                My Skills
            ...
            <div
              className=" mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6 lg:max-w-5xl items-start"
              data-aos="fade-up"
